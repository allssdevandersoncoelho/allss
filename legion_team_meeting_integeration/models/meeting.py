...
class CustomMeet(models.Model):
                ...
                if client_details.access_token and client_details.refresh_token:
                    ...
                    body = {
                        "message": {
                            ...
                            "body": {
                                "contentType": "HTML",
                                "content": "<div><a>You Are Invited to Meeting</a>""<p>"+self.name+"</p>""</div><dev><ul><li>Meeting URL: <a target=""_blank"" href="+self.team_url+">Join a Team Meeting</a></li><li>Meeting Date: <a>"+fields.Datetime.context_timestamp(self, self.start_datetime).isoformat(' ')+"</a></li><li>Meeting Description: <a>"+self.description+"</a></li> </ul></div>"                                    },
                            "toRecipients": [
                                {
                                    "emailAddress": {
                                    "address": i.email,
    ...
    def post_request_team_meet(self):
        ...
        start_datetime = fields.Datetime.context_timestamp(self, self.start_datetime).isoformat('T')
