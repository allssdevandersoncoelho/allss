...

{
    ...
    'summary': 'Send and receive messages. Real ChatRoom. WhatsApp integration. Send Product, Sale Order, Invoice, Partner. WhatsApp Connector. Chat-Api. ChatApi. Drag and Drop. ChatRoom 2.0.',
    'description': 'Send and receive messages. Real ChatRoom. WhatsApp integration. Send Product, Sale Order, Invoice and Partner. WhatsApp Connector. Chat-Api. ChatApi. Drag and Drop. ChatRoom 2.0.',
    'version': '13.0.1',
    'author': 'AcruxLab',
